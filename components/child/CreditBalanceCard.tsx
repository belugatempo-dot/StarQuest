...
export default function CreditBalanceCard({ balance, locale }: CreditBalanceCardProps) {
  ...
  return (
    <div className={`rounded-lg p-4 ${hasDebt ? "bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200" : "bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200"}`}>
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-600">{t("credit.yourBalance")}:</span>
        ...
        {hasDebt && (
          <div className="bg-white/60 rounded-lg p-3 space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">{t("credit.youOwe")}:</span>
        ...
        {!hasDebt && balance.available_credit > 0 && (
          <div className="flex justify-between items-center bg-white/60 rounded-lg p-3">
            <span className="text-sm text-gray-600">{t("credit.availableCredit")}:</span>
