...
const DEFAULT_CATEGORY_NAMES = [
  "health", "study", "chores", "hygiene", "learning", "social",
  "creativity", "exercise", "reading", "music", "art", "kindness",
...
export default function QuestFormModal({
  ...
  return (
    <ModalFrame
      title={isEditMode
        ? locale === "zh-CN" ? "编辑任务" : "Edit Quest"
        : locale === "zh-CN" ? "添加任务" : "Add Quest"}
      error={error}
      onClose={onClose}
      maxWidth="lg"
      stickyHeader
        ...
        <div className="flex items-center justify-end space-x-3 pt-4 border-t">
          ...
          <button type="submit" disabled={loading}
            ...
            {loading
              ...
              : locale === "zh-CN" ? "创建任务" : "Create Quest"}
          </button>
        </div>
      </form>
    </ModalFrame>
