  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (starsCost <= 0) {
      setError(
        locale === "zh-CN"
          ? "星星消耗必须大于0"
          : "Stars cost must be greater than 0"
      );
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {locale === "zh-CN"
                ? "兑换此奖励需要的星星数量"
                : "Number of stars needed to redeem this reward"}
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={
                locale === "zh-CN"
                  ? "描述这个奖励的详细信息..."
                  : "Describe this reward in detail..."
              }
            />
          </div>
